...
if len(parts) >= 2:
    ...
    if next_func_idx != -1:
        ...
        with open("app/main.py", "w", encoding="utf-8") as f:
            f.write(new_text)
        print("Success: overridden apply_ai_first_quality_overrides successfully")
    else:
        print("Error: Could not find build_ai_first_emergency_reply")
else:
    print("Error: apply_ai_first_quality_overrides not found")
